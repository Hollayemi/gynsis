...
export const validateCouponCreate = (req: Request, res: Response, next: NextFunction) => {
    const errors: string[] = [];
    const {
        promotionName,
        promoType,
...
export const validateCouponUpdate = (req: Request, res: Response, next: NextFunction) => {
    const errors: string[] = [];
    const {
        promotionName,
        promoType,
